...
| Action | Count |
|--------|-------|
| mcp_audit_ops.get_recent_actions | 62 |
| mcp_calendar_ops.get_current_week | 64 |
| gold_agent.agent_complete | 31 |
| mcp_file_ops.list_tasks | 97 |
| gold_agent.loop_start | 32 |
| ceo_briefing.save_briefing | 31 |
| domain_router.get_all_domain_tasks | 32 |
| gold_agent.loop_complete | 32 |
| gold_agent.agent_start | 32 |
| mcp_audit_ops.get_action_summary | 31 |
| mcp_file_ops.write_task | 35 |
| gold_agent.openai_fallback | 2 |
| mcp_file_ops.move_task | 2 |
| domain_router.classify_task | 4 |
| mcp_file_ops.read_task | 292 |
