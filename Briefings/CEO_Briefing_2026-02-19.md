...
**Generated:** 2026-02-19 10:08 UTC
...
| Action | Count |
|--------|-------|
| mcp_audit_ops.get_recent_actions | 18 |
| mcp_calendar_ops.get_current_week | 20 |
| gold_agent.agent_complete | 9 |
| mcp_file_ops.list_tasks | 31 |
| gold_agent.loop_start | 10 |
| ceo_briefing.save_briefing | 9 |
| domain_router.get_all_domain_tasks | 10 |
| gold_agent.loop_complete | 10 |
| gold_agent.agent_start | 10 |
| mcp_audit_ops.get_action_summary | 9 |
| mcp_file_ops.write_task | 13 |
| gold_agent.openai_fallback | 2 |
| mcp_file_ops.move_task | 2 |
| domain_router.classify_task | 4 |
| mcp_file_ops.read_task | 72 |
