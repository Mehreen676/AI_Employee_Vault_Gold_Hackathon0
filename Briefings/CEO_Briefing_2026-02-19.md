...
**Generated:** 2026-02-19 06:16 UTC
...
| Action | Count |
|--------|-------|
| mcp_audit_ops.get_recent_actions | 10 |
| mcp_calendar_ops.get_current_week | 12 |
| gold_agent.agent_complete | 5 |
| mcp_file_ops.list_tasks | 19 |
| gold_agent.loop_start | 6 |
| ceo_briefing.save_briefing | 5 |
| domain_router.get_all_domain_tasks | 6 |
| gold_agent.loop_complete | 6 |
| gold_agent.agent_start | 6 |
| mcp_audit_ops.get_action_summary | 5 |
| mcp_file_ops.write_task | 9 |
| gold_agent.openai_fallback | 2 |
| mcp_file_ops.move_task | 2 |
| domain_router.classify_task | 4 |
| mcp_file_ops.read_task | 32 |
