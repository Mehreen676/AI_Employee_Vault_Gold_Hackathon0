...
**Generated:** 2026-02-19 09:12 UTC
...
| Action | Count |
|--------|-------|
| mcp_audit_ops.get_recent_actions | 16 |
| mcp_calendar_ops.get_current_week | 18 |
| gold_agent.agent_complete | 8 |
| mcp_file_ops.list_tasks | 28 |
| gold_agent.loop_start | 9 |
| ceo_briefing.save_briefing | 8 |
| domain_router.get_all_domain_tasks | 9 |
| gold_agent.loop_complete | 9 |
| gold_agent.agent_start | 9 |
| mcp_audit_ops.get_action_summary | 8 |
| mcp_file_ops.write_task | 12 |
| gold_agent.openai_fallback | 2 |
| mcp_file_ops.move_task | 2 |
| domain_router.classify_task | 4 |
| mcp_file_ops.read_task | 62 |
