...
| Action | Count |
|--------|-------|
| mcp_audit_ops.get_recent_actions | 108 |
| mcp_calendar_ops.get_current_week | 110 |
| gold_agent.agent_complete | 54 |
| mcp_file_ops.list_tasks | 166 |
| gold_agent.loop_start | 55 |
| ceo_briefing.save_briefing | 54 |
| domain_router.get_all_domain_tasks | 55 |
| gold_agent.loop_complete | 55 |
| gold_agent.agent_start | 55 |
| mcp_audit_ops.get_action_summary | 54 |
| mcp_file_ops.write_task | 58 |
| gold_agent.openai_fallback | 2 |
| mcp_file_ops.move_task | 2 |
| domain_router.classify_task | 4 |
| mcp_file_ops.read_task | 522 |
